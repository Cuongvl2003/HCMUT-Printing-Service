...
call xem_lich_su_in_tu_SPSO('01-01-2023');
...
CREATE OR REPLACE FUNCTION check_account_exists(a1 varchar(30), a2 varchar(30))
RETURNS BOOLEAN AS
$$
DECLARE
    acc_exists BOOLEAN;
BEGIN
    SELECT EXISTS (SELECT 1 FROM tai_khoan WHERE a1=TenDangNhap and a2=MatKhau) INTO acc_exists;
    RETURN acc_exists;
END;
$$
LANGUAGE plpgsql;

select check_account_exists('dai123','123456');
